...
const Sponsor = ({ tier, image, sponsor, desc, button, website }: SponsorProps) => {
  switch (tier) {
    case 'Platinum':
      return (
        <div className="flex flex-col items-center gap-3 px-7 p-8 bg-black border border-white rounded-xl box-border">
    ...
    case 'Gold':
      return (
        <div
          className="flex flex-col items-center gap-3.5 px-7 py-8 bg-black border border-white rounded-xl box-border">
