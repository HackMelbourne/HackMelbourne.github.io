...
<div className="mt-8 flex flex-col h-[200vh] lg:min-h-[100vh] lg:h-[100vh] max-w-[1100px] lg:justify-between w-[80%] m-auto">
      ...
      {/* Second Event */}
      <div className="flex flex-col h-[32%] justify-center lg:h-[20%] lg:flex-row lg:justify-between lg:w-4/5 lg:self-end lg:gap-16">
        <motion.div
          className="order-2 lg:order-1 min-h-1/2 mt-2 lg:h-full lg:w-1/2 flex flex-col lg:gap-4 lg:justify-center justify-between align-center"
          variants={container}
          viewport={{ amount: 'all', once: true }}
          initial="hidden"
          whileInView="show">
