export const SPONSORSHIP_EMAIL = `sponsors@hack.melbourne`;
export const SECRETARY_EMAIL = `secretary@hack.melbourne`;
export const DISCORD_LINK = `https://discord.gg/tEQ5m6ayTV`;
export const FACEBOOK_LINK = `https://www.facebook.com/hack.melbourne/`;
export const LINKEDIN_LINK = `https://www.linkedin.com/company/hack.melbourne/`;
