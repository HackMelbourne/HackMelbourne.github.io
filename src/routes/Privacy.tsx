const Legal = () => {
  return (
    <div className="mt-40 w-screen max-w-[80%] md:max-w-[50%] m-auto flex flex-col gap-5">
      ...
      <ul>
        ...
        <li className="mt-2">
          <p>
            ...
            <a href="hack.melbourne" rel="external nofollow noopener" target="_blank">
              hack.melbourne
            </a>
          </p>
        </li>
      ...
      <h2 className="text-2xl md:text-4xl font-bold">Collecting and Using Your Personal Data</h2>
      <h3 className="text-xl md:text-2xl font-bold">Types of Data Collected</h3>
      <h4 className="text-lg md:text-xl font-bold">Personal Data</h4>
      <p>
      ...
      <h4 className="text-lg md:text-xl font-bold">Usage Data</h4>
      ...
      <h4 className="text-lg md:text-xl font-bold">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Use of Your Personal Data</h3>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Disclosure of Your Personal Data</h3>
      <h4 className="text-lg md:text-xl font-bold">Business Transactions</h4>
      <p>
      ...
      <h4 className="text-lg md:text-xl font-bold">Law enforcement</h4>
      <p>
      ...
      <h4 className="text-lg md:text-xl font-bold">Other legal requirements</h4>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="text-2xl md:text-4xl font-bold">Children's Privacy</h2>
      <p>
      ...
      <h2 className="text-2xl md:text-4xl font-bold">Changes to this Privacy Policy</h2>
      <p>
