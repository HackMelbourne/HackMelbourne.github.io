const Terms = () => {
  return (
    <div className="mt-40 w-screen max-w-[80%] md:max-w-[50%] m-auto flex flex-col gap-5">
      <h1 className="text-4xl md:text-6xl font-bold">Terms and Conditions</h1>
      <p>Last updated: January 12, 2024</p>
      <p>Please read these terms and conditions carefully before using Our Service.</p>
       <h2 className="text-2xl md:text-4xl font-bold">Interpretation and Definitions</h2>
      <h3 className="text-xl md:text-2xl font-bold">Interpretation</h3>
      <p>
        The words of which the initial letter is capitalized have meanings defined under the following conditions. The
        following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
      </p>
      <h3 className="text-xl md:text-2xl font-bold">Definitions</h3>
      ...
      <ul>
        ...
        <li className="mt-2">
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to HackMelbourne, Parkville VIC 3052.
          </p>
        </li>
        <li className="mt-2">
          <p>
        ...
        <li className="mt-2">
          <p>
            <strong>Website</strong> refers to HackMelbourne, accessible from{' '}
            <a href="https://hack.melbourne/" rel="external nofollow noopener" target="_blank">
              https://hack.melbourne/
            </a>
          </p>
        </li>
        <li className="mt-2">
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Acknowledgment</h2>
      <p>
      ...
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Links to Other Websites</h2>
      <p>
      ...
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Termination</h2>
      <p>
        We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
        whatsoever, including without limitation if You breach these Terms and Conditions.
      </p>
      <p>Upon termination, Your right to use the Service will cease immediately.</p>
       <h2 className="text-2xl md:text-4xl font-bold">Limitation of Liability</h2>
      <p>
      ...
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p>
      ...
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Governing Law</h2>
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Disputes Resolution</h2>
      <p>
        If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally
        by contacting the Company.
      </p>
       <h2 className="text-2xl md:text-4xl font-bold">For European Union (EU) Users</h2>
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">United States Legal Compliance</h2>
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Severability and Waiver</h2>
      <h3 className="text-xl md:text-2xl font-bold">Severability</h3>
      <p>
      ...
      <h3 className="text-xl md:text-2xl font-bold">Waiver</h3>
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Translation Interpretation</h2>
      <p>
       ...
       <h2 className="text-2xl md:text-4xl font-bold">Changes to These Terms and Conditions</h2>
      <p>
      ...
      <ul>
        <li className="mt-2">By email: student_engagement@hack.melbourne</li>
      </ul>
    </div>
  );
};
